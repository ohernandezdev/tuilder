...
const content: Record<Locale, Record<string, LessonText>> = {
  es: {
    ...
    '6.2': {
      ...
      task: 'Demuestra lo que sabes de la terminal',
    },
    '6.3': {
      ...
      why: 'Te doy instrucciones, t\u00fa decides qu\u00e9 comando usar.',
      task: 'Demuestra lo que sabes de Git',
    },
    '6.4': {
  ...
  en: {
    ...
    '6.2': {
      ...
      task: 'Show what you know about the terminal',
    },
    '6.3': {
      ...
      why: 'I\u2019ll give you instructions, you decide which command to use.',
      task: 'Show what you know about Git',
    },
    '6.4': {
    ...
    '6.6': {
      ...
      task: 'Congratulations, you made it!',
    },
  },
  fr: {
    '6.1': {
    ...
    '6.2': {
      ...
      task: 'Montre ce que tu sais du terminal',
    },
    '6.3': {
      ...
      why: 'Je te donne des instructions, tu d\u00e9cides quelle commande utiliser.',
      task: 'Montre ce que tu sais de Git',
    },
    '6.4': {
    ...
    '6.6': {
      ...
      task: 'F\u00e9licitations, tu as r\u00e9ussi !',
    },
  },
};
