...
const content: Record<Locale, Record<string, LessonText>> = {
  es: {
    ...
    '5.3': {
      ...
      module: 'Colaborar con el equipo',
      concept: 'Tus cambios solo existen en tu computadora hasta que los subes.\n\ngit push sube tu rama al servidor (GitHub, GitLab, etc.).\n\nHasta que no haces push, tu equipo no puede ver lo que hiciste.',
      why: 'Si tu computadora se rompe y no hiciste push, perdiste todo. Push = respaldo + colaboración.',
      task: 'Sube tus cambios al servidor',
      hint: 'Dos palabras: git + la acción de "subir"...',
      simulateLines: [
    ...
    '5.5': {
      ...
      task: 'Crea un Pull Request desde la terminal',
    ...
    '5.7': {
      ...
      task: '',
      simulateLines: ['', '  Ejemplo de review:', '  ───────────────────', '  ✅ El diff coincide con la descripción', '  ✅ Solo cambió lo que debía cambiar', '  ⚠️  ¿Por qué se modificó este archivo extra?', '', '  → Si algo no cuadra, pregunta antes de aprobar.', ''],
      simulateDelay: 250,
    },
    '5.8': {
      title: 'Cuándo NO usar el agente',
      module: 'Colaborar con el equipo',
      concept: 'No uses un agente de AI para:\n\n  • Seguridad y autenticación\n  • Pagos y facturación\n  • Migraciones de base de datos\n  • Publicar cambios en el sitio/app real (producción)\n\nCuando las consecuencias son grandes, un humano debe decidir.',
      why: 'Los agentes son increíbles para tareas repetitivas, pero no entienden las consecuencias de negocio.',
      task: '',
      simulateLines: ['', '  🚫 ZONA DE PELIGRO', '  ─────────────────', '  • Pagos y facturación', '  • Login y contraseñas', '  • Base de datos de producción', '  • Publicar al sitio real', '', '  → Para estas cosas, siempre un humano.', ''],
      simulateDelay: 250,
    },
    '5.9': {
      ...
      task: '',
      simulateLines: ['', '  🤝 Pide ayuda cuando:', '  ─────────────────', '  • 2 intentos fallidos → llama al dev', '  • No entiendes el error → pregunta', '  • Toca producción → siempre consulta', '', '  → Preguntar = profesionalismo, no debilidad.', ''],
      simulateDelay: 250,
    },
    '5.10': {
      ...
      task: 'Haz el flujo de colaboración: rama, add, commit, push',
    },
    '5.11': {
  ...
  en: {
    ...
    '5.3': {
      ...
      module: 'Collaborate with your team',
      concept: 'Your changes only exist on your computer until you upload them.\n\ngit push uploads your branch to the server (GitHub, GitLab, etc.).\n\nUntil you push, your team can\u2019t see what you did.',
      why: 'If your computer breaks and you didn\u2019t push, you lost everything. Push = backup + collaboration.',
      task: 'Upload your changes to the server',
      hint: 'Two words: git + the action of "uploading"...',
      simulateLines: [
        'Enumerating objects: 5, done.',
        'Counting objects: 100% (5/5), done.',
        'Writing objects: 100% (3/3), 312 bytes | 312.00 KiB/s, done.',
    ...
    '5.5': {
      ...
      task: 'Create a Pull Request from the terminal',
      hint: 'gh pr create --title "..." --body "..."',
      simulateLines: [
        '',
    ...
    '5.7': {
      ...
      task: '',
      simulateLines: ['', '  Review example:', '  ───────────────────', '  ✅ The diff matches the description', '  ✅ Only changed what it should', '  ⚠️  Why was this extra file modified?', '', '  → If something doesn\'t add up, ask before approving.', ''],
      simulateDelay: 250,
    },
    '5.8': {
      title: 'When NOT to use the agent',
      module: 'Collaborate with your team',
      concept: 'Don\u2019t use an AI agent for:\n\n  \u2022 Security and authentication\n  \u2022 Payments and billing\n  \u2022 Database migrations\n  \u2022 Publishing changes to the live site/app (production)\n\nWhen the stakes are high, a human should decide.',
      why: 'Agents are amazing for repetitive tasks, but they don\u2019t understand business consequences.',
      task: '',
      simulateLines: ['', '  🚫 DANGER ZONE', '  ─────────────────', '  • Payments and billing', '  • Login and passwords', '  • Production database', '  • Publishing to the live site', '', '  → For these, always a human.', ''],
      simulateDelay: 250,
    },
    '5.9': {
      ...
      task: '',
      simulateLines: ['', '  🤝 Ask for help when:', '  ─────────────────', '  • 2 failed attempts → call the dev', '  • You don\'t understand the error → ask', '  • It touches production → always consult', '', '  → Asking = professionalism, not weakness.', ''],
      simulateDelay: 250,
    },
    '5.10': {
      ...
      task: 'Do the collaboration flow: branch, add, commit, push',
    },
    '5.11': {
  ...
  fr: {
    ...
    '5.3': {
      ...
      module: 'Collaborer avec ton \u00e9quipe',
      concept: 'Tes changements n\u2019existent que sur ton ordinateur tant que tu ne les envoies pas.\n\ngit push envoie ta branche au serveur (GitHub, GitLab, etc.).\n\nTant que tu ne fais pas push, ton \u00e9quipe ne peut pas voir ce que tu as fait.',
      why: 'Si ton ordinateur tombe en panne et que tu n\u2019as pas fait push, tu as tout perdu. Push = sauvegarde + collaboration.',
      task: 'Envoie tes changements au serveur',
      hint: 'Deux mots : git + l\'action d\u2019"envoyer"...',
      simulateLines: [
        'Enumerating objects: 5, done.',
        'Counting objects: 100% (5/5), done.',
        'Writing objects: 100% (3/3), 312 bytes | 312.00 KiB/s, done.',
    ...
    '5.5': {
      ...
      task: 'Crée un Pull Request depuis le terminal',
      hint: 'gh pr create --title "..." --body "..."',
      simulateLines: [
        '',
    ...
    '5.7': {
      ...
      task: '',
      simulateLines: ['', '  Exemple de review :', '  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500', '  \u2705 Le diff correspond \u00e0 la description', '  \u2705 Seul ce qui devait changer a chang\u00e9', '  \u26a0\ufe0f  Pourquoi ce fichier suppl\u00e9mentaire a \u00e9t\u00e9 modifi\u00e9 ?', '', '  \u2192 Si quelque chose ne colle pas, demande avant d\'approuver.', ''],
      simulateDelay: 250,
    },
    '5.8': {
      title: 'Quand NE PAS utiliser l\u2019agent',
      module: 'Collaborer avec ton \u00e9quipe',
      concept: 'N\u2019utilise pas un agent IA pour :\n\n  \u2022 S\u00e9curit\u00e9 et authentification\n  \u2022 Paiements et facturation\n  \u2022 Migrations de base de donn\u00e9es\n  \u2022 Publier des changements sur le site/app en ligne (production)\n\nQuand les enjeux sont \u00e9lev\u00e9s, un humain doit d\u00e9cider.',
      why: 'Les agents sont incroyables pour les t\u00e2ches r\u00e9p\u00e9titives, mais ils ne comprennent pas les cons\u00e9quences m\u00e9tier.',
      task: '',
      simulateLines: ['', '  \ud83d\udeab ZONE DE DANGER', '  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500', '  \u2022 Paiements et facturation', '  \u2022 Login et mots de passe', '  \u2022 Base de donn\u00e9es de production', '  \u2022 Publier sur le site en ligne', '', '  \u2192 Pour \u00e7a, toujours un humain.', ''],
      simulateDelay: 250,
    },
    '5.9': {
      ...
      task: '',
      simulateLines: ['', '  \ud83e\udd1d Demande de l\'aide quand :', '  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500', '  \u2022 2 tentatives \u00e9chou\u00e9es \u2192 appelle le dev', '  \u2022 Tu ne comprends pas l\'erreur \u2192 demande', '  \u2022 \u00c7a touche la production \u2192 consulte toujours', '', '  \u2192 Demander = professionnalisme, pas faiblesse.', ''],
      simulateDelay: 250,
    },
    '5.10': {
      ...
      task: 'Fais le flux de collaboration : branche, add, commit, push',
    },
    '5.11': {
