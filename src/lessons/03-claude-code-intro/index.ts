...
const content: Record<Locale, Record<string, LessonText>> = {
  es: {
    '3.1': {
      ...
      task: '',
      simulateLines: ['', '  Tu instrucción:', '  > "El botón de login dice Sign In. Cámbialo a Iniciar Sesión"', '', '  El agente:', '  > Leyendo src/Login.tsx...', '  > Cambié el texto del botón.', '  > ✓ Listo.', ''],
      simulateDelay: 200,
    },
    '3.2': {
      ...
      task: '',
      simulateLines: ['', '  ✅ Cambiar un texto → rápido y seguro', '  ✅ Renombrar una variable → sin problemas', '  ✅ Crear un componente nuevo → con guía', '', '  ❌ "¿Deberíamos cobrar $9 o $19?" → eso lo decides TÚ', '  ❌ "¿Este diseño está bien?" → eso lo decides TÚ', ''],
      simulateDelay: 300,
    },
    '3.3': {
      title: 'Cómo hablarle al agente',
      module: 'Tu Primer Agente de AI',
      concept: 'Sé específico. Describe lo que ves y lo que quieres.\n\nBuen prompt:\n  "El botón dice Click me. Cámbialo a Empezar"\n\nMal prompt:\n  "hazlo mejor"\n\nEntre más claro describas lo que quieres, mejor resultado.\n\nEl agente conoce el código y encontrará el archivo correcto. Tú solo describe el cambio.',
      ...
      simulateLines: [
        ...
        '',
        '✅ Prompt bueno: "El botón dice Click me. Cámbialo a Empezar"',
        '   Resultado:   El agente encuentra el archivo y cambia el texto.',
      ],
      simulateDelay: 400,
    },
    '3.4': {
    ...
    '3.10': {
      ...
      module: 'Tu Primer Agente de AI',
      concept: 'Imagina que estás en un proyecto real. Tu equipo te pide cambiar un color, revisar el resultado y guardar. Hazlo paso a paso.',
  ...
  en: {
    '3.1': {
      ...
      task: '',
      simulateLines: ['', '  Your instruction:', '  > "The login button says Sign In. Change it to Log In"', '', '  The agent:', '  > Reading src/Login.tsx...', '  > Changed the button text.', '  > ✓ Done.', ''],
      simulateDelay: 200,
    },
    '3.2': {
      ...
      task: '',
      simulateLines: ['', '  ✅ Change a text → fast and safe', '  ✅ Rename a variable → no problem', '  ✅ Create a new component → with guidance', '', '  ❌ "Should we charge $9 or $19?" → YOU decide that', '  ❌ "Is this design good?" → YOU decide that', ''],
      simulateDelay: 300,
    },
    '3.3': {
      title: 'How to talk to the agent',
      module: 'Your First AI Agent',
      concept: 'Be specific. Describe what you see and what you want.\n\nGood prompt:\n  "The button says Click me. Change it to Get started"\n\nBad prompt:\n  "make it better"\n\nThe clearer you describe what you want, the better the result.\n\nThe agent knows the code and will find the right file. You just describe the change.',
      ...
      simulateLines: [
        ...
        '',
        '✅ Good prompt: "The button says Click me. Change it to Get started"',
        '   Result:     The agent finds the file and changes the text.',
      ],
      simulateDelay: 400,
    },
    '3.4': {
    ...
    '3.10': {
      ...
      module: 'Your First AI Agent',
      concept: 'Imagine you\'re in a real project. Your team asks you to change a color, review the result, and save. Do it step by step.',
  ...
  fr: {
    '3.1': {
      ...
      task: '',
      simulateLines: ['', '  Ton instruction :', '  > "Le bouton de login dit Sign In. Change-le en Se connecter"', '', '  L\'agent :', '  > Lecture de src/Login.tsx...', '  > Texte du bouton changé.', '  > ✓ Terminé.', ''],
      simulateDelay: 200,
    },
    '3.2': {
      ...
      task: '',
      simulateLines: ['', '  ✅ Changer un texte → rapide et sûr', '  ✅ Renommer une variable → sans problème', '  ✅ Créer un nouveau composant → avec guidage', '', '  ❌ "On facture 9€ ou 19€ ?" → c\'est TOI qui décides', '  ❌ "Ce design est bon ?" → c\'est TOI qui décides', ''],
      simulateDelay: 300,
    },
    '3.3': {
      title: 'Comment parler à l\'agent',
      module: 'Ton Premier Agent IA',
      concept: 'Sois spécifique. Décris ce que tu vois et ce que tu veux.\n\nBon prompt :\n  "Le bouton dit Click me. Change-le en Commencer"\n\nMauvais prompt :\n  "améliore ça"\n\nPlus tu décris clairement ce que tu veux, meilleur sera le résultat.\n\nL\'agent connaît le code et trouvera le bon fichier. Tu n\'as qu\'à décrire le changement.',
      ...
      simulateLines: [
        ...
        '',
        '✅ Bon prompt :     "Le bouton dit Click me. Change-le en Commencer"',
        '   Résultat :      L\'agent trouve le fichier et change le texte.',
      ],
      simulateDelay: 400,
    },
    '3.4': {
    ...
    '3.10': {
      ...
      module: 'Ton Premier Agent IA',
      concept: 'Imagine que tu es dans un projet réel. Ton équipe te demande de changer une couleur, vérifier le résultat et sauvegarder. Fais-le étape par étape.',
...
const quizModule3: Record<Locale, QuizQuestionData[]> = {
  es: [
    { question: '¿Qué debe incluir un buen prompt?', options: ['Qué ves y qué quieres cambiar', 'Solo "arréglalo"', '"Hazlo mejor"', 'El agente lo adivinará'], correct: 0, explanation: 'Describe lo que ves en la página y qué quieres que cambie. El agente encontrará el archivo correcto.' },
  ...
  en: [
    { question: 'What should a good prompt include?', options: ['What you see and what you want changed', 'Just "fix it"', '"Make it better"', 'The agent will figure it out'], correct: 0, explanation: 'Describe what you see on the page and what you want changed. The agent will find the right file.' },
  ...
  fr: [
    { question: 'Que doit inclure un bon prompt ?', options: ['Ce que tu vois et ce que tu veux changer', 'Juste "corrige ça"', '"Améliore ça"', 'L\'agent devinera'], correct: 0, explanation: 'Décris ce que tu vois sur la page et ce que tu veux changer. L\'agent trouvera le bon fichier.' },
...
const practiceModule3: Record<Locale, CommandStep[]> = {
  es: [
    { challenge: 'Pídele al agente que cambie un color', command: 'cambiar color', acceptPattern: 'cambia|color|change', output: ['El agente propone el cambio...', 'Cambio aplicado.'], hint1: 'Escribe una instrucción natural, como si hablaras con alguien...', hint2: 'Escribe: cambiar color' },
  ...
  en: [
    { challenge: 'Ask the agent to change a color', command: 'change color', acceptPattern: 'change|color|cambia', output: ['The agent proposes the change...', 'Change applied.'], hint1: 'Write a natural instruction, like talking to someone...', hint2: 'Type: change color' },
  ...
  fr: [
    { challenge: 'Demande à l\'agent de changer une couleur', command: 'changer couleur', acceptPattern: 'change|couleur|color', output: ['L\'agent propose le changement...', 'Changement appliqué.'], hint1: 'Écris une instruction naturelle, comme si tu parlais à quelqu\'un...', hint2: 'Tape : changer couleur' },
...
export function getModule3Lessons(locale: Locale): Lesson[] {
  ...
  return [
    // 3.1 — concept only
    {
      ...
      simulate: buildSimulate(c['3.1']!),
    },
    // 3.2 — concept + simulate
    {
      id: '3.2',
      ...c['3.2']!,
      validate: () => ({ valid: true, message: '' }),
      simulate: buildSimulate(c['3.2']!),
    },
