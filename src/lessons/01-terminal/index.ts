...
const content: Record<Locale, Record<string, LessonText>> = {
  es: {
    ...
    '1.6': {
      ...
      module: 'La Terminal Sin Miedo',
      concept: 'Mira cómo tu pantalla ya se llenó de texto con los comandos anteriores. A veces se vuelve difícil de leer.\n\nEl comando clear limpia todo y te deja una pantalla nueva. No borra nada de verdad — solo limpia lo que ves.',
      why: 'Es como limpiar tu escritorio antes de empezar algo nuevo. Te ayuda a concentrarte.',
      task: 'La pantalla está llena. Escribe clear para limpiarla',
  ...
  en: {
    ...
    '1.6': {
      ...
      module: 'The Terminal Without Fear',
      concept: 'Look how your screen is already full of text from previous commands. Sometimes it gets hard to read.\n\nThe command clear cleans everything and gives you a fresh screen. It doesn\u2019t delete anything \u2014 it just cleans what you see.',
      why: 'It\u2019s like clearing your desk before starting something new. Helps you focus.',
      task: 'The screen is full. Type clear to clean it',
  ...
  fr: {
    ...
    '1.6': {
      ...
      module: 'Le Terminal Sans Peur',
      concept: 'Regarde comme ton écran est déjà plein de texte des commandes précédentes. Parfois ça devient difficile à lire.\n\nLa commande clear nettoie tout et te donne un écran neuf. Ça n\u2019efface rien pour de vrai — ça nettoie juste ce que tu vois.',
      why: 'C\u2019est comme ranger ton bureau avant de commencer quelque chose de nouveau. Ça aide à se concentrer.',
      task: 'L\u2019écran est plein. Tape clear pour le nettoyer',
